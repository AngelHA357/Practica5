    ...
    fun agregarProductos(imageView: ImageView, option: String?){
        when(option){
            "Antojitos" -> {
                ...
                menu.add(Product("Quesadillas",R.drawable.quesadillas,"Rellenas con tu carne favorita, servidas con ensalada. Filled with your choice of meat, served with salad.",5.69))
                menu.add(Product("Huaraches",R.drawable.huaraches,"Tortill gruesa con frijoles, tu carne favorita, lechuga, queso fresco y crema. Big Thick tortilla with beans, your choice of meat, fresh cheese, and sour cream",10.99))
                ...
                menu.add(Product("Sincronizada", R.drawable.sincronizadas,"Tortilla de harina rellena con queso y jamón. Acompañada de lechuga, crema y guacamole. Two flour tortillas filled with ham and cheese. Served with lettuce, sour cream, and guacamole.", 7.99));
            ...
            "Especialidades" -> {
                ...
                menu.add(Product("Torre de Camarón Negro", 0,"", 16.99))
                menu.add(Product("Botana de Pulpo a la Diabla", 0,"Servido con totopos, cebolla frita, arroz, lechuga y pico de gallo. Served with chips, grilled onions, rice, lettuce, and pico de gallo.", 24.99))
                menu.add(Product("Botana de Pulpo al Mojo de Ajo", 0,"Servido con totopos, cebolla frita, arroz, lechuga y pico de gallo. Served with chips, grilled onions, rice, lettuce, and pico de gallo.", 24.99))
                menu.add(Product("Pulpo al Mojo de Ajo", 0,"", 35.00))
                menu.add(Product("Pulpo Zarandeado", 0,"", 35.00))
